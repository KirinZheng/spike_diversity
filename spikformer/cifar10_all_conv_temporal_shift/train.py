...
## modify the order of maxpooling lif
...
parser.add_argument("--feature_dimension_group_number", type=int, default=3)
parser.add_argument("--temporal_construction_factor", type=float, default=1.0)
...
def main():
    ...
    model = create_model(
        ...
        feature_dimension_group_number=args.feature_dimension_group_number,
        temporal_construction_factor=args.temporal_construction_factor,
    )
