...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 torchrun --nproc_per_node=8 --master_port 29501 /zhengzeqi/code/zhengzeqi/QKFormer_original/imagenet_1K_finetune/train.py \
    --output_dir /zhengzeqi/code/zhengzeqi/QKFormer_original/imagenet_1K_finetune/output/10_768_T_4_224_3d_pe_arch_4_finetune \
    --log_dir /zhengzeqi/code/zhengzeqi/QKFormer_original/imagenet_1K_finetune/output/10_768_T_4_224_3d_pe_arch_4_finetune \
